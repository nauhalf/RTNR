...
public class RealTimeSpeechEnhancer {

    private final String tflitePath = "nutls_lstm.tflite";
    ...
    public RealTimeSpeechEnhancer(Context context, int frame_len, int stride) throws IOException {
